...
public class sendEmail {
    //发件人的邮箱和授权码
    private final String myEmailAccount = "3143357252@qq.com";//发送的邮箱
    private final String myEmailPassword = "kuyiowcfpgzqddaj";
    ...
    public MimeMessage createMessage(Session session, String sendMail, String receiveMail, String info) throws Exception {
        ...
        message.setFrom (new InternetAddress (sendMail, "集可爱,温柔,智慧于一身的女孩才不会秃头呢~", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient (MimeMessage.RecipientType.TO, new InternetAddress (receiveMail, "xx用户", "UTF-8"));
        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject ("Hotpop订餐系统验证码", "UTF-8");
        // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
        message.setContent ("欢迎您使用Hotpop订餐系统，您注册账号的验证码：:" + info, "text/html;charset=UTF-8");
        // 6. 设置发件时间
    ...
    public static void main(String[] args) {
                ...
                //设置要发送的邮箱
                sendEmail.setReceiveMailAccount("3143357252@qq.com");
                //创建10位发验证码
